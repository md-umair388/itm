		...
		<body>	
           <!---header--->
		    <?php
			  ...
			  ?>
			  <div id="logo">
			        <a href="index.php"><img style="width:100%; padding-top:25px;" src="img/itmheader.jpg" alt="" title="" /> </a>
			    </div>	
    ...
    <section class="banner-area relative " style="background-color: rgba(4,9,30,0.9);" id="home" >	
	    <div class="overlay overlay-bg"></div>
	        <div class="row d-flex align-items-center justify-content-center">
					...
					<div id="ninja-slider" style="padding:0;"> 
                         <div class="slider-inner" style="max-width:90%; height:380px;" >
							<ul>
								<?php 
									 include("connect.php");
									 $condition="Slider";
									 ...
									 { ?> 
											<li style="height:50%;">
												<?php echo ("<img class='ns-img' src='img/photos/".$row['photo']."'> ");?>
												<div style="font-size:30px;color:orange;" class="caption"><center><b><?php echo ($row['title']);?></b></center></div>
											</li>
										<?php
									 }
								?>
