				...
				<div class="container">				
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="index.php">Message</a><span class="lnr lnr-arrow-right"></span>  <a href="mregistrar.php">Registrar</a></p>
						</div>	
					</div>
				</div>
			</section>
					...
					<div class="col-md-12">
						<div class="container  d-flex justify-content-center">
							<?php
							 ...
							 include("connect.php");
							  $result=mysqli_query($con,"select *from management where designation='Registrar' AND status=1");
