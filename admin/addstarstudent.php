				    ...
				    {   if($file_size > 2097152)
					 ...
					 else
					 {
						 ?><script> alert(" Please Select valid Image");
						            window.location="addstarstudent.php";
						 </script><?php
					 }
				}
				 else
		 ...
		 if(isset($_POST['register']))
			{   
				...
				{	
				  ...
				  $status=1;
			      include("connect.php");
				  mysqli_query($con,"insert into starstudent(department,name,year,description,photo,status) values('$department','$name','$year','$description','$photo','$status')");
    ...
    <div id="wrapper">
		...
		<!--------------------------Main body--------------------------------------->
		 <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1>Star Student</small></h1>
                    <div class="alert alert-dismissable alert-warning">
                        <button data-dismiss="alert" class="close" type="button">&times;</button>
                        Welcome to the Star Student dashboard of ITM Group of Institutions update Star Student corners easily. 
                        <br />
