				    ...
				    {   if($file_size > 2097152)
					 ...
					 else
					 {
						 ?><script> alert(" Please Select valid Image");
						            window.location="editpopwindow.php";
						 </script><?php
					 }
				}
				 else
		 ...
		 if(isset($_POST['register']))
			{   
				...
				{	
				  ...
				  $title=$_POST['title'];
			      include("connect.php");
				  mysqli_query($con,"update popwindow set title='$title',photo='$photo',status=1 where id=$id");
                ...
                <div class="col-lg-12">
                    ...
                    <div class="alert alert-dismissable alert-warning">
                        <button data-dismiss="alert" class="close" type="button">&times;</button>
                         Welcome to the pop up window dashboard ! Feel free to edit pop up window section. 
                        <br />
		 ...
		 <!-- start banner Area -->
			...
			<section class="info-area pb-40">
				<div class="container-fluid">
				    <div class="col-md-12">
					  ...
					  <?php
							include("connect.php");
							$id=$_GET['data_id'];
							$result=mysqli_query($con,"select * from popwindow where id=$id and status=1");
				...
				<tr>
					...
					&nbsp;&nbsp;
					<?php  echo ("<img  src='../img/popwindow/".$row['photo']."' class='img-fluid'>");?>
					</td>
				</tr>
