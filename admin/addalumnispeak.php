				    ...
				    {   if($file_size > 2097152)
					 ...
					 else
					 {
						 ?><script> alert(" Please Select valid Image");
						            window.location="addalumnispeak.php";
						 </script><?php
					 }
				}
				 else
		 ...
		 if(isset($_POST['register']))
			{   
				...
				{	
				  ...
				  $status=1;
			      include("connect.php");
				  mysqli_query($con,"insert into alumnispeak(name,description,photo,company,status) values('$name','$description','$photo','$company','$status')");
    ...
    <div id="wrapper">
		...
		<!--------------------------Main body--------------------------------------->
		 <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1>Alumni Section</h1>
                    <div class="alert alert-dismissable alert-warning">
                        <button data-dismiss="alert" class="close" type="button">&times;</button>
                        Welcome to the Alumni Section, here You can Manage everything Related to Alumni. 
                        <br />
		 ...
		 <!--------------------------------------------------------------->
			...
			<section class="info-area pb-40">
				...
				<tr>
					...
					</textarea><br/><span class="text-danger" id="description_error"></span>
					</td>
				</tr>
