		 ...
		 if(isset($_POST['register']))
			{   
				...
				{	
				  ...
				  $status=1;
			      include("connect.php");
				  mysqli_query($con,"insert into hod(name,department,qualification,experience,briefprofile,photo,status) values('$name','$department','$qualification','$experience','$briefprofile','$photo','$status')");
		...
		<!--------------------------Main body--------------------------------------->
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="alert alert-dismissable alert-warning">
                        ...
                        Welcome to the hod dashboard of ITM Group of Institutions update hod information corners easily. 
                        <br />
		 ...
		 <section class="banner-area relative about-banner" id="home" >	
			...
			<section class="info-area pb-40">
				...
				<tr>
					<td>Qualification:</td>
					<td><textarea class="form-control" id="qualification" name="qualification" onblur="checkTextBox(this)">
				...
				<tr>
					<td>Experience:</td>
					<td><textarea class="form-control" id="experience" name="experience" onblur="checkTextBox(this)">
				...
				<tr>
					<td>Brief Profile:</td>
					<td><textarea class="form-control" id="briefprofile" name="briefprofile" onblur="checkTextBox(this)">
