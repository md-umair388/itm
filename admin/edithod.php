			...
			{ if(is_uploaded_file($_FILES['image']['tmp_name']))
				{
				    ...
				    {   if($file_size > 2097152)
						...
						{
						 if(move_uploaded_file($tmp,"../img/hod/".$filename))
						 {   $photo=$filename;
					         $condition=1;
		 ...
		 if(isset($_POST['register']))
			{   
				...
				{	
					  ...
					  include("connect.php");
					  mysqli_query($con,"update hod set name='$name',department='$department',qualification='$qualification',briefprofile='$briefprofile',photo='$photo',status=1 where id=$id");
					   if(mysqli_affected_rows($con)==1)
						{   ?><script> alert(" Data Uploaded Successfully");
							window.location="showhod.php";
							</script><?php
						}
					   else
					  {
		...
		<!--------------------------Main body--------------------------------------->
                ...
                <div class="col-lg-12">
                    ...
                    <div class="alert alert-dismissable alert-warning">
                        <button data-dismiss="alert" class="close" type="button">&times;</button>
                         Welcome to the HOD dashboard ! Feel free to delete and modify HOD section. 
                        <br />
		 ...
		 <!-- start banner Area -->
			...
			<section class="info-area pb-40">
				<div class="container-fluid">
				    <div class="col-md-12">
					  ...
					  <?php
							include("connect.php");
							$id=$_GET['data_id'];
							$result=mysqli_query($con,"select * from hod where id=$id and status=1");
				...
				<tr>
					<td>Qualification:</td>
					<td><textarea class="form-control" id="qualification" name="qualification" onblur="checkTextBox(this)"><?php echo $row['qualification']?>
					</textarea><span class="text-danger" id="qualification_error"></span>
					</td>
				</tr>
				
				<tr>
					<td>Experience:</td>
					<td><textarea class="form-control" id="experience" name="experience" onblur="checkTextBox(this)"><?php echo $row['experience']?>
					</textarea><span class="text-danger" id="experience_error"></span>
					</td>
				</tr>
				
				<tr>
					<td>Brief Profile:</td>
					<td><textarea class="form-control" id="briefprofile" name="briefprofile" onblur="checkTextBox(this)"><?php echo $row['briefprofile']?>
					</textarea><span class="text-danger" id="briefprofile_error"></span>
					</td>
				</tr>
				...
				<tr>
					...
					&nbsp;&nbsp;
					<?php  echo ("<img  src='../img/hod/".$row['photo']."' class='img-fluid'>");?>
					</td>
				</tr>
				<tr>
					<td></td>
...
<script>
			function validate()
			{
				...
				else
				{
					...
					{
						document.getElementById("name").focus();
						document.getElementById("name_error").innerHTML="Please Enter Valid data";
						return false;
					}
