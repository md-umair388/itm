<?php
		 ...
		 if(isset($_POST['register']))
			{   	
				  ...
				  $status=1;
			      include("connect.php");
				  mysqli_query($con,"insert into cr(department,year,name,position,status) values('$department','$year','$name','$position','$status')");
    ...
    <div id="wrapper">
		...
		<!--------------------------Main body--------------------------------------->
		 <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1>Class Representative</small></h1>
                    <div class="alert alert-dismissable alert-warning">
                        <button data-dismiss="alert" class="close" type="button">&times;</button>
                        Welcome to the Class Representative dashboard of ITM Group of Institutions update Class Representative corners easily. 
                        <br />
		 ...
		 <section class="banner-area relative about-banner" id="home" >	
			...
			<section class="info-area pb-40">
				...
				<tr>
					<td>Year:</td>
					<td>
						<input type="text" name="year" id="year" class="form-control" onblur="checkTextBox(this)">
				...
				<tr>
					<td>Position:</td>
					<td>
						<input type="text" name="position" id="position" class="form-control" onblur="checkTextBox(this)">
