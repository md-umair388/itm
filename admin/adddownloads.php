			...
			{ if(is_uploaded_file($_FILES['image']['tmp_name']))
				{
					 ...
					 $file_size = $_FILES['image']['size'];
				      ...
				      if($file_size > 2097152)
						...
						{
						 if(move_uploaded_file($tmp,"../img/downloads/".$filename))
						 {   $photo=$filename;
					         $condition=1;
				 ...
				 else
				 {
					 ?><script> alert(" Please select a file to Upload Or Your file is more than 2 MB");
					            window.location="adddownloads.php";
					 </script><?php
				 }
		    }
		 ...
		 if(isset($_POST['register']))
			{   
				...
				{	
				  ...
				  $status=1;
			      include("connect.php");
				  mysqli_query($con,"insert into downloads(title,photo,status) values('$title','$photo','$status')");
    ...
    <div id="wrapper">
		...
		<!--------------------------Main body--------------------------------------->
		 <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1>Downloads</small></h1>
                    <div class="alert alert-dismissable alert-warning">
                        <button data-dismiss="alert" class="close" type="button">&times;</button>
                        Welcome to the downloads Portion, Here you can easily manage the downloads. 
						<br />
